...
static CfgParam cfgP[] = {
  ...
  {"biP", "boy.iridPh",     &boy.iridPh,      'i',  "5"},
  {"bnD", "boy.ngkDelay",   &boy.ngkDelay,    'i',  "8"},
  {"bfO", "boy.fallOpTO",   &boy.fallOpTO,    'i',  "30"},
  {"bfR", "boy.fallRetry",  &boy.fallRetry,   'i',  "3"},
  {"brO", "boy.riseOpTO",   &boy.riseOpTO,    'i',  "30"},
  ...
  {"gre", "gps.hdrPause",   &gps.hdrPause,    'i',  "15"},
  {"gre", "gps.hdrTry",     &gps.hdrTry,      'i',  "3"},
  {"gre", "gps.redial",     &gps.redial,      'i',  "5"},
  {"grR", "gps.rudResp",    &gps.rudResp,     'i',  "10"},
  ...
  {"who", "wsp.hour",       &wsp.hour,        'i',  "60"},
  {"wda", "wsp.day",        &wsp.day,         'i',  "24"},
  {"wd1", "wsp.day1",       &wsp.day1,        'i',  "15"},
