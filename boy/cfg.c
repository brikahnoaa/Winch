...
static CfgParam cfgP[] = {
  {"aau", "ant.auton",      &ant.auton,       'b',  "false"},
  {"asC", "ant.sampClear",  &ant.sampClear,   'b',  "true"},
  {"asS", "ant.sampStore",  &ant.sampStore,   'b',  "true"},
  ...
  {"bdW", "boy.depWait",    &boy.depWait,     'i',  "240"},
  {"bsT", "boy.depSettle",  &boy.depSettle,   'i',  "120"},
  {"bfO", "boy.fallOp",     &boy.fallOp,      'i',  "30"},
  {"bfR", "boy.fallRetry",  &boy.fallRetry,   'i',  "3"},
  {"bfP", "boy.filePause",  &boy.filePause,   'i',  "1"},
  ...
  {"gfX", "gps.fileMax",    &gps.fileMax,     'i',  "2000"},
  {"gfB", "gps.fileBlock",  &gps.fileBlock,   'i',  "512"},
  ...
  {"wst", "wsp.storm",      &wsp.storm,       'b',  "true"},
