...
static CfgParam cfgP[] = {
  ...
  {'i',  "boy.dataRestM", &boy.dataRestM,   "bdR",  "20"},
  {'i',  "boy.dataRunM",  &boy.dataRunM,    "bdn",  "10"},
  {'i',  "boy.depSetlM",  &boy.depSetlM,    "bdS",  "60"},
  {'i',  "boy.depWaitM",  &boy.depWaitM,    "bdW",  "240"},
  {'i',  "boy.fallOpM",   &boy.fallOpM,     "bfO",  "30"},
  {'i',  "boy.iridOpM",   &boy.iridOpM,     "biO",  "5"},
  {'i',  "boy.ngkMaxS",   &boy.ngkMaxS,     "bnM",  "10"},
