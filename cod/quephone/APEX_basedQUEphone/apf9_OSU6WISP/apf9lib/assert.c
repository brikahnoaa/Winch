...
/*------------------------------------------------------------------------*/
/* function to handle assertion failures                                  */
/*------------------------------------------------------------------------*/
/**
   This function handles assertion failures by printing a diagnostic to
   stdout and then exiting the program.

   \begin{verbatim}
   input:
      line ... The line number where the assertion failed.
      file ... The name of the translation unit that contained the assertion
               that failed.
      expr ... The string-ized representation of the expression that failed.
   \end{verbatim}
*/
void _fassert(int line, const char *file, const char *expr)
{
