...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * $Id: crc16bit.c,v 1.7 2007/04/24 01:43:29 swift Exp $
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 *
 * Revision 1.4  2003/07/19 18:52:59  swift
 * Changed the name of 'bit' to 'i' to avoid the use of a keyword
 * under HiTech's C compiler.
 *
 * Revision 1.3  1997/08/17 00:55:04  swift
 * Included results of statistical tests to the comment section.
 *
 * Revision 1.2  1997/08/15 10:58:22  swift
 * Minor modification to comment section.
 *
 * Revision 1.1  1997/08/14 19:09:05  swift
 * Initial revision
 *
 *========================================================================*/
...
/**
   ...
   Check Value: msg="SwiftWare::Crc16Bit()" --> CRC=0x5c5d.
...
unsigned int Crc16Bit(const unsigned char *msg,unsigned int len)
{
   ...
   unsigned const int kernel=0x1021;
