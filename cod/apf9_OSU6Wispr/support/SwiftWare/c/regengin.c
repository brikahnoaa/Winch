/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * $Id: regengin.c,v 1.1 2005/02/22 22:03:17 swift Exp $
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
/** 
   This C source code implements the main engine of a POSIX regular
   ...
   No modifications have been made to the functionality.  The nature of the
   modifications are mostly repackaging of the source code.

 * RCS log of revisions to the C source code.
 *
 * \begin{verbatim}
 * $Log: regengin.c,v $
 * Revision 1.1  2005/02/22 22:03:17  swift
 * Added part of regex functionality.
 *
 * Revision 1.3  2003/07/07 14:45:15  swift
 * Added watchdog resets and stack-checks for the APF9 firmware work.
 *
 * Revision 1.2  2003/07/03 22:53:09  swift
 * Eliminated unreachable 'break' statements that caused compiler complaints.
 *
 * Revision 1.1  2002/10/08 23:53:48  swift
 * Initial revision
 * \end{verbatim}
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define RegengineChangeLog "$RCSfile: regengin.c,v $  $Revision: 1.1 $   $Date: 2005/02/22 22:03:17 $"
...
/* Beginning of Regengine.ih header file */
#ifdef __cplusplus
extern "C" {
#endif
...
#endif
/* End of Regengine.ih header file */
