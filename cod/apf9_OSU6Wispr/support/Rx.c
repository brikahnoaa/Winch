...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * $Id: rx.c,v 1.6 2008/07/14 17:03:59 swift Exp $
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
 ...
 * \end{verbatim}
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define RxChangeLog "$RCSfile: rx.c,v $  $Revision: 1.6 $   $Date: 2008/07/14 17:03:59 $"
...
/* specify 16-bit CRC as the default corruption detection method */
int CrcMode='C';

/* specify the transfer mode (binary or ascii) to be binary by default */
int BinMode=1;
...
long int Rx(const struct SerialPort *port,FILE *dest)
{
   ...
   else
   {
      ...
      {
         if (debuglevel>=1 || (debugbits&RX_H))
         {
            /* create the message */
      ...
      for (pktbytes=0,bytes_read=0,NPkt=0,PktNum=1; ;PktNum++,NPkt++)
      {
         ...
         for (pkt_status=NoPkt, try=1; pkt_status<=NoPkt && try<=NRetry; try++)
         {
            ...
            switch (pkt_status)
            {
               ...
               case FalseEot:
               {
                  if (debuglevel>=2 || (debugbits&RX_H))
                  {
                     /* create the message */
               ...
               case ShortPkt: 
               {
                  ...
                  {
                     /* create the message */
                     static cc msg[]="Truncated packet received - retrying.\n";
               ...
               case BadPkt: 
               {
                  ...
                  {
                     /* create the message */
                     static cc msg[]="Corrupt packet received - retrying.\n";
               ...
               case NoPkt: 
               {
                  ...
                  else if (debuglevel>=2 || (debugbits&RX_H))
                  {
                     /* create the message */
            ...
            if (debuglevel>=4 || (debuglevel>=3 && pkt_status<OkPkt)) LogPacket(&pkt);
         }
